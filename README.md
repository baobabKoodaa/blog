...
- Basic setup
  - Switch to old version of Node: `nvm install v12 | nvm use v12`
  - Switch to old version of gatsby-cli in this Node environment: `npm install -g gatsby-cli@latest-v2`
